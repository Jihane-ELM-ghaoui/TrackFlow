      ...
      <section id="services" className="section-services">
        <div className="centered-container">
          ...
          <p className="section-description">
            CyberLearn provides essential tools to optimize your work and enhance collaboration within your team.
          </p>
          ...
          <div className="centered-container">
            ...
            <div className="testimonial-grid">
              <div className="testimonial-box">
                <p>"CyberLearn's project tracking tools have transformed the way our team collaborates. Highly recommended!"</p>
              ...
              <div className="testimonial-box">
                ...
                <h4>- Nabila Bazar, Product Manager at Cyberlearn</h4>
              </div>
            </div>
          </div>
        </section>
