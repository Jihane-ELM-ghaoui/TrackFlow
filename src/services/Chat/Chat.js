...
//       const response = await axios.get('http://localhost:8001/api/messages/receivers', {
//         headers: {
...
//       const response = await axios.get(`http://localhost:8080/api/protected/search`, {
//         params: { email },
//         headers: {
//           Authorization: `Bearer ${idToken}`,
//         },
...
//       const response = await axios.get(`http://localhost:8001/api/messages?receiver=${sanitizedReceiver}`, {
//         headers: {
//           Authorization: `Bearer ${idToken}`,
//         },
//       });
...
//       fetchReceivers();
//     } catch (error) {
//       console.error('Error fetching receivers after receiving messages:', error);
//     }
...
//               <p className="SBChat-message">Click to view messages</p>
...
//             />
//             <button onClick={() => handleSendMessage(selectedReceiver)}>Send</button>
//           </div>
//         ) : (
//           <div>
//             <p></p>
